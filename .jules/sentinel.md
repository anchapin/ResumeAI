...
## 2026-04-13 - [SQL Injection via String Formatting in BatchMigrationManager]
...
**Learning:** Similar to the vulnerability found in `schema_manager.py`, `sqlalchemy.text()` does NOT sanitize variables passed into it via Python string formatting (like f-strings).
