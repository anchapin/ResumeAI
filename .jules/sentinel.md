...
## 2026-05-29 - Prevent SQL Injection in Dynamic Queries
**Vulnerability:** Constructing dynamic database queries using f-strings inside SQLAlchemy's text() creates SQL injection vulnerabilities.
**Learning:** Never use string formatting to inject table or column names dynamically.
**Prevention:** Always use SQLAlchemy's core table(), column(), and select() constructs to safely quote and escape dynamic identifiers.
