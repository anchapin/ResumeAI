...
def upgrade() -> None:
    ...
    op.create_index('ix_user_github_connections_id', 'user_github_connections', ['id'], unique=False)
    # Create custom indexes from __table_args__
    op.create_index('idx_github_connections_user', 'user_github_connections', ['user_id'], unique=False)
    op.create_index('idx_github_connections_github_user', 'user_github_connections', ['github_user_id'], unique=False)
