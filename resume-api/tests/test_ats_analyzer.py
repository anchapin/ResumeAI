...
class TestATSCheckResult:
    ...
    def test_result_creation(self):
        ...
        result = ATSCheckResult(file_type="pdf", ats_score=75, is_parseable=True, word_count=500)
    ...
    def test_result_with_issues(self):
        ...
        result = ATSCheckResult(
            file_type="pdf", ats_score=65, is_parseable=True, word_count=400, issues=issues
        )
