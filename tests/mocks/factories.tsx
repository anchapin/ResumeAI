 ...
 */
export function createMock<T extends Record<string, any>>(defaults: T, options?: MockOptions<T>): Partial<T> {
...
export function createMockProject(overrides?: Partial<ProjectItem>): ProjectItem {
  return {
