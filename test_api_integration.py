...
class TestRenderPDfEndpoint:
    ...
    def test_render_pdf_success_with_valid_data(self, sample_resume_data, valid_api_key):
    ...
    def test_render_pdf_with_different_variants(self, sample_resume_data, valid_api_key):
