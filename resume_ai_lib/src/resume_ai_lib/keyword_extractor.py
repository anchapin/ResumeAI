...
class KeywordExtractor:
    ...
    TECH_KEYWORDS = {
        ...
        "devops": [
            ...
            "circleci", "github actions", "gitlab ci", "ci/cd", "devops",
            "nginx", "apache", "load balancer", "microservices",
        ],
        "tools": [
            "git", "github", "gitlab", "jira", "confluence", "slack",
            "datadog", "grafana", "prometheus", "nagios", "splunk",
        ],
    }
