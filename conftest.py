...
os.environ.setdefault("REQUIRE_API_KEY", "False")  # Disable API key requirement for tests
os.environ.setdefault("ENABLE_RATE_LIMITING", "False")  # Disable rate limiting for tests
