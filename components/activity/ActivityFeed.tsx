                  ...
                  <div className="flex items-center space-x-1">
                    {!notification.is_read && (
                      <button
                        ...
                        className="text-gray-400 hover:text-blue-600 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
                        title="Mark as read"
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-red-600 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded"
                      title="Delete"
