...
export const NotificationsBell: React.FC<NotificationsBellProps> = ({ onOpenPanel }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="relative p-2 text-gray-400 hover:text-gray-600 transition rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
      title="Notifications"
        ...
        <div className="flex items-center space-x-2">
          {unreadCount > 0 && (
            <button
              ...
              className="text-sm text-blue-600 hover:text-blue-800 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
            >
              Mark all read
            </button>
          )}
          {onClose && (
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-600 rounded-lg p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                  ...
                  <div className="flex items-center space-x-1">
                    {!notification.is_read && (
                      <button
                        ...
                        className="text-gray-400 hover:text-blue-600 p-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                        title="Mark as read"
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-red-600 p-1 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                      title="Delete"
