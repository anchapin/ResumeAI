  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2" role="tablist" aria-label="Compare mode">
          <button
            role="tab"
            aria-selected={compareMode === 'side-by-side'}
            onClick={() => setCompareMode('side-by-side')}
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary-500 ${
