 ...
 *   }}
 *   isExpanded={true}
 *   onToggleExpand={(id) => doSomething(id)}
 *   onDelete={(id) => doSomething(id)}
 *   onUpdate={(id, field, value) => doSomething(id, field, value)}
 *   onAddTag={(id, tag) => doSomething(id, tag)}
 *   onRemoveTag={(id, tag) => doSomething(id, tag)}
 * />
 * ```
 */
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 pt-4 border-t border-slate-100">
              <div className="space-y-2">
                <label htmlFor={`company-${exp.id}`} className="text-sm font-bold text-slate-700">
                  Company Name
                </label>
                <input
                  id={`company-${exp.id}`}
              ...
              <div className="space-y-2">
                <label htmlFor={`role-${exp.id}`} className="text-sm font-bold text-slate-700">
                  Job Title
                </label>
                <input
                  id={`role-${exp.id}`}
              ...
              <div className="space-y-2">
                <label htmlFor={`startDate-${exp.id}`} className="text-sm font-bold text-slate-700">
                  Start Date
                </label>
                <input
                  id={`startDate-${exp.id}`}
              ...
              <div className="space-y-2">
                <label htmlFor={`endDate-${exp.id}`} className="text-sm font-bold text-slate-700">
                  End Date
                </label>
                <input
                  id={`endDate-${exp.id}`}
            ...
            <div className="space-y-3">
              <label htmlFor={`description-${exp.id}`} className="text-sm font-bold text-slate-700">
