 ...
 * Wrapped with React.memo to prevent expensive re-renders when parent components update.
 * This component receives a complex `comparison` object and renders a large number of nested
 * UI elements. Memoizing it avoids redundant diffing when its props haven't changed.
 */
export const OfferComparison = React.memo(
  ({ comparison, onExport }: OfferComparisonProps) => {
